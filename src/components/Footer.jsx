    ...
    >
      <div className="px-4 sm:px-6 lg:px-8">
        <div className="flex flex-wrap justify-between items-start">
          ...
          >
            <h3 className="text-2xl font-bold mb-4 hover:text-blue-500">
              Contact Us
            </h3>
            <div className="flex items-center mb-2">
              <FaMapMarkerAlt className="mr-2" />
              <p className="text-xl hover:text-blue-500">
            ...
            <div className="flex items-center mb-2">
              ...
              <a
                href="tel:+1234567890"
                className="text-xl hover:text-blue-500 underline transition-colors"
              >
                +1 234 567 890
              </a>
            </div>
            <div className="flex items-center">
              ...
              <a
                ...
                className="text-xl text-blue-400 hover:text-blue-500 underline transition-colors"
              >
