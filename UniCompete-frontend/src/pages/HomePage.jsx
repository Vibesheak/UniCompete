...
import homeVideo2 from "./HomeBack2.mp4";
import homeVideo3 from "./HomeBack3.mp4";
import homeVideo4 from "./HomeBack4.mp4";
  ...
  return (
    ...
    <div className="min-h-screen flex">
      <div className="relative w-full h-[95vh]">
        <video
          src={homeVideo4} // Ensure this path is correct
          autoPlay
          loop
          muted
        ...
        <div className="absolute inset-0 top-[40%] -translate-y-1/2 flex flex-col justify-center items-end text-blue-600 p-4 sm:p-8">
          <div className="max-w-xs sm:max-w-sm md:max-w-md lg:max-w-lg text-left pr-4 sm:pr-8">
            ...
            >
              ...
              <span className="text-purple-600 text-5xl ml-2"> Opportunities</span>
            </h1>
            ...
            <div className="left-[calc(65%+80px)]">
              ...
              <div className="max-w-3xl mx-auto text-center mt-8 l text-center">
                ...
                <p className="text-sm sm:text-base md:text-lg font-light mb-8 text-center text-black"><b>
